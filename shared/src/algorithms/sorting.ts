...
export function* bubbleSortSteps(arr: number[]): Generator<SortingStep, void, unknown> {
  let array = [...arr];
  let stepNumber = 0;
...
export function* mergeSortSteps(arr: number[]): Generator<SortingStep, void, unknown> {
  let array = [...arr];
  let stepNumber = 0;
...
export function* quickSortSteps(arr: number[]): Generator<SortingStep, void, unknown> {
  let array = [...arr];
  let stepNumber = 0;
